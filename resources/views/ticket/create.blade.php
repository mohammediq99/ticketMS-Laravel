...
<div class="">
  ...
  <form method="post" action="{{ route('ticket.store')}}">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control {{ $errors->has('summury') ? 'is-invalid' : '' }}" id="summury"  name="summury" value="{{ old('summury')}}">
      @if($errors->has('summury'))
      <span class="help-block">
        <strong>{{ $errors->first('summury')}}</strong>
